    ...
    protected void createNewShape(int x, int y) {
        ...
        switch (currentShapeType) {
		    case 0: { //rectangle
		         ...
		         case 1: { //square
		           shapes.add( new MovingSquare(x, y, currentHeight,marginWidth, marginHeight, currentBorderColor,currentFillColor,currentMessage,currentPath));
		           break;
		         }
		         case 2:{ //ellipse
		         ...
		         case 4:{ //circle
		       	  shapes.add( new MovingSpinningCircle(x, y, currentHeight, marginWidth, marginHeight, currentBorderColor,currentFillColor,currentMessage,currentPath));
		             break;
		         }
       }}   
